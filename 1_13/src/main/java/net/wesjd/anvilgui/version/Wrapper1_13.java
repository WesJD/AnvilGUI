...
/**
 * {@link VersionWrapper} implemented for NMS version 1.13
 *
 * @author Wesley Smith
 * @since 1.2
 */
public class Wrapper1_13 implements VersionWrapper {
    ...
    public AnvilContainerWrapper newContainerAnvil(Player player, Object guiTitle) {
        return new Wrapper1_13.AnvilContainer(toNMS(player));
    }
