...
/**
 * {@link VersionWrapper} implemented for NMS version 1.11
 *
 * @author Wesley Smith
 * @since 1.1.1
 */
public class Wrapper1_11 implements VersionWrapper {
    ...
    public AnvilContainerWrapper newContainerAnvil(Player player, Object guiTitle) {
        return new Wrapper1_11.AnvilContainer(toNMS(player));
    }
