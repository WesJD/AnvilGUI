...
/**
 * {@link VersionWrapper} implemented for NMS version 1.13.1
 *
 * @author Wesley Smith
 * @since 1.2.1
 */
public class Wrapper1_13_1 implements VersionWrapper {
    ...
    public AnvilContainerWrapper newContainerAnvil(Player player, Object guiTitle) {
        return new Wrapper1_13_1.AnvilContainer(toNMS(player));
    }
